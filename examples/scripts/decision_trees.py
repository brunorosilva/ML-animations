...
class DecisionTreeClassifierAnimation(DecisionTreeClassifier):
    """
    Creates a 2D DecisionTreeClassifier decision boundary animation 
    with all chosen parameters this class is inherted from sklearn, 
    so you may chose whatever you like with the init params
    """
    def __init__(self):
        super().__init__() # inheriting from DecisionTreeClassifier
...
k.save("..\\animations\\decision_trees.gif", writer='imagemagick')