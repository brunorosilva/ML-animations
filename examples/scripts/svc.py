...
class SVCAnimation(SVC):
    """
    Creates a 2D SVC decision boundary animation 
    with all chosen parameters this class is inherted from sklearn, 
    so you may chose whatever you like with the init params
    """
    def __init__(self):
        super().__init__(probability=True) # inheriting from SVC
...
k.save("..\\animations\\svc.gif", writer='imagemagick')